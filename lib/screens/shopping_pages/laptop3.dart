...
class Laptop3 extends StatefulWidget {
  @override
  _Laptop3State createState() => _Laptop3State();
}

class _Laptop3State extends State<Laptop3> {
  File _imageFile;
                ...
                child:Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text("Microsoft surface 4",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:25,color: Colors.black)),),
                      SizedBox(height: 5.0,),
                      ImageBanner("assets/images/microsoft4.jpg"),
