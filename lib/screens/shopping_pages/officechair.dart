...
class _OfficeChairsState extends State<OfficeChairs> {
  ...
  /*Future downloadImage() async
  {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title:Text("Office Stuff",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:30,color: Colors.black)),),
      ),
