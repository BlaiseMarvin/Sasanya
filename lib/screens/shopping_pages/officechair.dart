...
import 'package:sasanya/screens/shopping_pages/officedesk.dart';
import 'package:sasanya/screens/shopping_pages/satowear.dart';
import 'package:sasanya/screens/shopping_pages/stywom.dart';
...
class OfficeChairs extends StatefulWidget {
  @override
  _OfficeChairsState createState() => _OfficeChairsState();
}

class _OfficeChairsState extends State<OfficeChairs> {
  File _imageFile;
    ...
    return loading? Loading() : Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title:Text("Office Stuff",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:30,color: Colors.white)),),
          actions: [
        ...
        body: SingleChildScrollView(
            ...
            children: [
                  ...
                  child:Card(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("Office Chairs for you",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:25,color: Colors.black)),),
                        SizedBox(height: 5.0,),
                        ImageBanner("assets/images/officechairs.jpg"),
                        SizedBox(height:20.0 ),
                        Text("Choose item, that you'd want to exchange this pair of chairs for. ",textAlign: TextAlign.center,style: GoogleFonts.pacifico(textStyle:TextStyle(fontSize:20,)),),
                        SizedBox(height:10.0 ),
                        ...
                        _uploaded==false?Container():Text("Your bid has been logged, click next to continue",textAlign: TextAlign.center,style: GoogleFonts.pacifico(textStyle:TextStyle(fontSize: 20)),)
                        /*RaisedButton(
              ...
              RaisedButton(
                  color: Colors.red,
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>OfficeDesk()));
                  },
