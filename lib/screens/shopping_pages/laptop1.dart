...
class _Laptop1State extends State<Laptop1> {
  ...
  /*Future downloadImage() async
  {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title:Text("The Laptop Center",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:30,color: Colors.black)),),
      ),
