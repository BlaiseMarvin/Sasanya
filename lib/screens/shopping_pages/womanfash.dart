...
class WomanFash extends StatefulWidget {
  @override
  _WomanFashState createState() => _WomanFashState();
}

class _WomanFashState extends State<WomanFash> {
  File _imageFile;
    ...
    return loading?Loading(): Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title:Text("Ladies'",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:30,color: Colors.white)),),
          actions: [
                  ...
                  child:Card(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("Ladies' casual suit",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:25,color: Colors.black)),),
                        SizedBox(height: 5.0,),
                        ImageBanner("assets/images/fashwom.jpg"),
