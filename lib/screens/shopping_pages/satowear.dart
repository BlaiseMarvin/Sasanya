...
class SatoWear extends StatefulWidget {
  @override
  _SatoWearState createState() => _SatoWearState();
}

class _SatoWearState extends State<SatoWear> {
  File _imageFile;
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
            ...
            children: [
                  ...
                  child:Card(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("Weekend Wear",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:25,color: Colors.black)),),
                        SizedBox(height: 5.0,),
                        ImageBanner("assets/images/casualsato.jpg"),
                        ...
                        _uploaded==false?Container():Text("Your bid has been logged",textAlign: TextAlign.center,style: GoogleFonts.pacifico(textStyle:TextStyle(fontSize: 20)),)
                        /*RaisedButton(
              ...
              /*RaisedButton(
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>CasualMen()));
                  },
                  child: Text("Next",textAlign: TextAlign.center,style: GoogleFonts.pacifico(textStyle:TextStyle(fontSize:20,)),),
                  ),*/
