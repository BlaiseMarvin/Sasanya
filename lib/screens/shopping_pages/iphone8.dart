    ...
    return loading? Loading() : Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title:Text("Smartphones",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:30,color: Colors.white)),),
          actions: [
