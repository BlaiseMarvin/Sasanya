...
class Iphone8 extends StatefulWidget {
  @override
  _Iphone8State createState() => _Iphone8State();
}

class _Iphone8State extends State<Iphone8> {
  File _imageFile;
  ...
  /*Future downloadImage() async
  {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title:Text("The Smartphone Center",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:30,color: Colors.black)),),
      ),
      body: SingleChildScrollView(
          ...
          children: [
                ...
                child:Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text("Foldable samsung, good condition",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:25,color: Colors.black)),),
                      SizedBox(height: 5.0,),
                      ImageBanner("assets/images/smartphone.jpg"),
                      SizedBox(height:20.0 ),
                      Text("Choose item, that you'd want to exchange this phone for. ",textAlign: TextAlign.center,style: GoogleFonts.pacifico(textStyle:TextStyle(fontSize:20,)),),
                      SizedBox(height: 10.0),
            ...
            /*RaisedButton(
                color: Colors.red,
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>Iphone6()));
                },
