...
import 'package:sasanya/screens/shopping_pages/laptop3.dart';
...
class Laptop2 extends StatefulWidget {
  @override
  _Laptop2State createState() => _Laptop2State();
}

class _Laptop2State extends State<Laptop2> {
  File _imageFile;
  ...
  /*Future downloadImage() async
  {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title:Text("Laptop Centre",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:30,color: Colors.black)),),
      ),
      body: SingleChildScrollView(
          ...
          children: [
            Container(
                child:Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text("HP Amazon",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:25,color: Colors.black)),),
                      SizedBox(height: 5.0,),
                      ImageBanner("assets/images/hpamazon.jpg"),
                ...
                color: Colors.red,
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>Laptop3()));
                },
