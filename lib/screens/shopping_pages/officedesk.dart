...
class OfficeDesk extends StatefulWidget {
  @override
  _OfficeDeskState createState() => _OfficeDeskState();
}

class _OfficeDeskState extends State<OfficeDesk> {
  File _imageFile;
        ...
        body: SingleChildScrollView(
            ...
            children: [
                  ...
                  child:Card(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("The Perfect Desk for you",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:25,color: Colors.black)),),
                        SizedBox(height: 5.0,),
                        ImageBanner("assets/images/officedesk.jpg"),
                        SizedBox(height:20.0 ),
                        Text("Choose item, that you'd want to exchange this desk for. ",textAlign: TextAlign.center,style: GoogleFonts.pacifico(textStyle:TextStyle(fontSize:20,)),),
                        SizedBox(height:10.0 ),
              ...
              /*RaisedButton(
                  color: Colors.red,
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>StyWom()));
                  },
