...
import 'package:sasanya/screens/shopping_pages/kablu.dart';
...
class StyWom extends StatefulWidget {
  @override
  _StyWomState createState() => _StyWomState();
}

class _StyWomState extends State<StyWom> {
  File _imageFile;
        ...
        body: SingleChildScrollView(
            ...
            children: [
                  ...
                  child:Card(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("Ladies' office wear",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:25,color: Colors.black)),),
                        SizedBox(height: 5.0,),
                        ImageBanner("assets/images/stywom.jpg"),
              ...
              RaisedButton(
                  color: Colors.red,
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>KaBlu()));
                  },
