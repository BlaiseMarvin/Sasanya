                  ...
                  child:Card(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("Ford Mustang",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:25,color: Colors.black)),),
                        SizedBox(height: 5.0,),
                        ImageBanner("assets/images/fordmustang.jpg"),
