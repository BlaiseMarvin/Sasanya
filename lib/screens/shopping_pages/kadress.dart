...
class KaDress extends StatefulWidget {
  @override
  _KaDressState createState() => _KaDressState();
}

class _KaDressState extends State<KaDress> {
  File _imageFile;
                  ...
                  child:Card(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("Evening walk dress",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:25,color: Colors.black)),),
                        SizedBox(height: 5.0,),
                        ImageBanner("assets/images/kadress.jpg"),
