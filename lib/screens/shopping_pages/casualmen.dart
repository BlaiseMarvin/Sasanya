...
import 'package:sasanya/screens/shopping_pages/menjacket.dart';
...
class CasualMen extends StatefulWidget {
  @override
  _CasualMenState createState() => _CasualMenState();
}

class _CasualMenState extends State<CasualMen> {
  File _imageFile;
      ...
      body: SingleChildScrollView(
          ...
          children: [
                ...
                child:Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text("Casual Men Outfit",textAlign: TextAlign.center,style: GoogleFonts.bangers(textStyle:TextStyle(fontWeight:FontWeight.bold,fontSize:25,color: Colors.black)),),
                      SizedBox(height: 5.0,),
                      ImageBanner("assets/images/mencasual.jpg"),
                      ...
                      _imageFile==null?Container(): RaisedButton(
                        ...
                        child: Text("Upload your bid",textAlign: TextAlign.center,style: GoogleFonts.pacifico(textStyle:TextStyle(fontSize:20,color: Colors.white)),),
            ...
            RaisedButton(
              color: Colors.red,
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>MenJacket()));
